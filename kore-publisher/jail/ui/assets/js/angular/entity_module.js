const entity = angular.module("entity", ['session_checker', 'footer', 'logout', 'ui_urls', 'entity_sidebar']);

var d;
var SCOPE;

entity.controller('entityCtrl', function($scope, $compile, $http){
    ...
    $scope.addEntity=function(){
      ...
      $http({
          method: 'POST',
          url: api['entity']['register-entity'],
          headers: {
              'id': $scope.id,
              'apikey': $scope.apikey,
                    ...
                    <th scope="row">
                      <div class="media align-items-center">
                        <a href="#" class="avatar rounded-circle mr-3">
                          <img alt="Image placeholder" src="../../assets/img/logo/entity-1.png">
                        </a>
