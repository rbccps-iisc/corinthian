...
message_type="protected", is_priority="false", admin_id="", admin_key=""):
	...
	if as_admin == False:
		...
		for app, apikey in app_keys.items():
			...
			assert_exit(approved == expected, "Approved = "+str(approved)+"Expected = "+str(expected))
...
def app_subscribe(devices, app_keys, expected, message_type=""):
	...
	for app, apikey in app_keys.items():
		...
		assert_exit(actual == expected, "Actual = "+str(actual)+"Expected = "+str(expected))
		actual = 0
...
def share_dev(expected, admin_id, admin_key):
	...
	assert_exit(count == expected, "Count= "+str(count)+"Expected = "+str(expected))
